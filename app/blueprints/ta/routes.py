...
TA_CSP = {
    ...
    "script-src": [
        ...
        "https://cdn.bokeh.org/bokeh/release/bokeh-3.8.2.min.js",
        "https://cdn.bokeh.org/bokeh/release/bokeh-widgets-3.8.2.min.js",
    ...
    "style-src": [
        ...
        "https://cdn.bokeh.org/bokeh/release/bokeh-3.8.2.min.css",
        "'unsafe-inline'",
    ],
    "connect-src": [
        "'self'",
...
@bp.route("/")
@talisman(content_security_policy=TA_CSP)
def index() -> str:
    """主頁面路由，處理表單並顯示圖表。
